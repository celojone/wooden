  ...
  <div>
    ...
    <div style="height: 60px; display: flex;">
      <div style="width: 240px; display: flex; align-items: center; padding-left: 20px; background-color: #3a456b">
        ...
        <span style="font-size: 20px; font-weight: bold; color: #f1f1f1; margin-left: 5px">木业公司系统</span>
      </div>
      ...
      <div style="width: 240px;">
        <el-menu router :default-openeds="['1', '2']" :default-active="router.currentRoute.value.path" style="min-height: calc(100vh - 60px)">
          ...
          <el-sub-menu index="1">
            ...
            <el-menu-item index="/manager/category">产品分类</el-menu-item>
            <el-menu-item index="/manager/introduction">产品攻略</el-menu-item>
            <el-menu-item index="/manager/apply">请假申请</el-menu-item>
            <el-menu-item index="/manager/book">产品信息</el-menu-item>
            <el-menu-item index="/manager/record">购买记录</el-menu-item>
          </el-sub-menu>
