  ...
  <div>
    ...
    <div class="card" style="margin-bottom: 5px">
      <el-table :data="data.tableData" style="width: 100%" :header-cell-style="{ color: '#333', backgroundColor: '#eaf4ff' }">
        ...
        <el-table-column prop="author" label="产品经理" />
        ...
        <el-table-column label="操作" width="100">
          ...
          <template #default="scope" v-else>
            <el-button type="primary" @click="borrow(scope.row)">订购</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
    ...
    <el-dialog title="产品信息" v-model="data.formVisible" width="30%" destroy-on-close>
      <el-form ref="formRef" :model="data.form" :rules="data.rules" label-width="80px" style="padding: 20px 30px 10px 0">
        <el-form-item prop="img" label="产品图">
          <el-upload
        ...
        <el-form-item prop="name" label="产品名字">
          <el-input v-model="data.form.name" autocomplete="off" placeholder="请输入产品名字" />
        </el-form-item>
        <el-form-item prop="price" label="产品价格">
          <el-input v-model="data.form.price" autocomplete="off" placeholder="请输入产品价格" />
        </el-form-item>
        <el-form-item prop="author" label="产品经理">
          <el-input v-model="data.form.author" autocomplete="off" placeholder="请输入产品经理" />
        </el-form-item>
        <el-form-item prop="num" label="剩余数量">
          <el-input v-model="data.form.num" autocomplete="off" placeholder="请输入剩余数量格" />
        </el-form-item>
      </el-form>
      <template #footer>
...
const data = reactive({
  ...
  rules: {
    ...
    name: [
      { required: true, message: '请填写产品名字', trigger: 'blur' }
    ],
    price: [
